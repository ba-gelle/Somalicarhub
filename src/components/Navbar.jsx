import { Car, Plus, LogIn, LogOut, UserPlus, ChevronDown, Heart, Palette, Check, X } from 'lucide-react'
...
export default function Navbar() {
  const { currentUser, canAddCar, logout, setShowLoginModal, setShowRegisterModal, setShowAddModal,
          favorites, cars, theme, setTheme, toggleFavorite } = useApp()
  ...
  // Use CSS variables — the data-theme attribute on documentElement drives everything
    ...
    <nav style={{ position: 'sticky', top: 0, zIndex: 40, width: '100%' }}>
      ...
      <div style={{
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
          ...
          {/* Divider */}
          <div style={{ width: '1px', height: '22px', background: 'var(--nav-border)', flexShrink: 0 }} />
