    ...
    <div style={{ display: 'flex', justifyContent: 'center', width: '100%' }}>
      ...
      <div style={{
        ...
        <div style={{
          ...
          width: '100%', height: '5px', background: '#F58802', borderRadius: '0 0 6px 6px',
        }} />

        {/* ── Filter columns ── */}
        {FILTERS.map(({ id, label, Icon, options }) => (
          <div key={id} style={{ display: 'flex', flexDirection: 'column', gap: '5px', flex: isMobile ? 'none' : 1, minWidth: 0 }}>
            <label style={{ textTransform: 'uppercase', fontSize: '10px', fontWeight: 800, color: '#fff', letterSpacing: '1px', fontFamily: "'DM Sans', sans-serif", paddingLeft: '2px' }}>
              {label}
            </label>
            <div style={{ position: 'relative', display: 'flex', alignItems: 'center' }}
              ...
              <select
                ...
                style={{
                  background: '#ffffff', border: '1.5px solid transparent', borderRadius: '10px',
                  padding: '10px 34px 10px 33px', color: '#0f172a', fontSize: '13px', fontWeight: 600,
                ...
                onBlur={(e) => { e.currentTarget.style.borderColor = 'transparent'; e.currentTarget.style.boxShadow = '0 1px 4px rgba(0,0,0,0.06)' }}>
        ...
        {!isMobile && <div style={{ width: '3px', height: '42px', background: '#ffffff', borderRadius: '2px', flexShrink: 0, marginBottom: '1px' }} />}

        {/* ── Search button ── */}
        <div style={{ display: 'flex', flexDirection: 'column', gap: '5px', flexShrink: 0 }}>
          {!isMobile && <label style={{ fontSize: '10px', color: 'transparent', userSelect: 'none' }}>.</label>}
          <button
            style={{
